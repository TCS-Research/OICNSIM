...
#ifndef IPV4_ROUTER_L3_PROTOCOL_H
#define IPV4_ROUTER_L3_PROTOCOL_H
...
class Ipv4RouterL3ProtocolTestCase;
...
/**
 * \brief Implement the Ipv4 layer in an ICN Router.
 *
 * This is exactly the same as the Ipv4L3Protocol of ns3. The only
 * slight difference being that the Receive API in this class calls
 * the SublayerProtocol APIs to do an additional check on whether
 * the received packet is OICN packet or not. This is what makes the
 * ICN Router stand-out from a regular router, and enables overlay of
 * OICN Architecture with regular internet architecture. Please refer
 * to the Ipv4L3Protocol class in ns3 for further information on
 * implementation of Ipv4 layer.
 */

class Ipv4RouterL3Protocol : public Ipv4
{
public:
  /**
  ...
  /**
     ...
     * It also checks whether the packet is OICN packet or not
...
private:
  friend class ::Ipv4RouterL3ProtocolTestCase;
   ...
   */
  Ipv4RouterL3Protocol(const Ipv4RouterL3Protocol &);
   ...
   */
  Ipv4RouterL3Protocol &operator = (const Ipv4RouterL3Protocol &);
