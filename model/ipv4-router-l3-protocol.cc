...
#include "ipv4-router-l3-protocol.h"
#include "ns3/icmpv4-l4-protocol.h"
#include "ns3/ipv4-interface.h"
#include "ns3/ipv4-interface-address.h"
#include "ns3/ipv4-raw-socket-impl.h"

NS_LOG_COMPONENT_DEFINE ("Ipv4RouterL3Protocol");

namespace ns3 {


const uint16_t Ipv4RouterL3Protocol::PROT_NUMBER = 0x0800;

NS_OBJECT_ENSURE_REGISTERED (Ipv4RouterL3Protocol);

TypeId 
Ipv4RouterL3Protocol::GetTypeId (void)
{

  static TypeId tid = TypeId ("ns3::Ipv4RouterL3Protocol")
    .SetParent<Ipv4> ()
    .AddConstructor<Ipv4RouterL3Protocol> ()
    .AddAttribute ("DefaultTos", "The TOS value set by default on all outgoing packets generated on this node.",
                   UintegerValue (0),
                   MakeUintegerAccessor (&Ipv4RouterL3Protocol::m_defaultTos),
                   MakeUintegerChecker<uint8_t> ())
    .AddAttribute ("DefaultTtl", "The TTL value set by default on all outgoing packets generated on this node.",
                   UintegerValue (64),
                   MakeUintegerAccessor (&Ipv4RouterL3Protocol::m_defaultTtl),
                   MakeUintegerChecker<uint8_t> ())
    .AddAttribute ("FragmentExpirationTimeout",
                   "When this timeout expires, the fragments will be cleared from the buffer.",
                   TimeValue (Seconds (30)),
                   MakeTimeAccessor (&Ipv4RouterL3Protocol::m_fragmentExpirationTimeout),
                   MakeTimeChecker ())
    .AddAttribute ("InterfaceList", "The set of Ipv4 interfaces associated to this Ipv4 stack.",
                   ObjectVectorValue (),
                   MakeObjectVectorAccessor (&Ipv4RouterL3Protocol::m_interfaces),
...
Ipv4RouterL3Protocol::Ipv4RouterL3Protocol()
{
...
void
Ipv4RouterL3Protocol::Insert (Ptr<IpL4Protocol> protocol)
{
  m_protocols.push_back (protocol);
}
Ptr<IpL4Protocol>
Ipv4RouterL3Protocol::GetProtocol (int protocolNumber) const
{
...
void
Ipv4RouterL3Protocol::Remove (Ptr<IpL4Protocol> protocol)
{
  m_protocols.remove (protocol);
}

void
Ipv4RouterL3Protocol::SetNode (Ptr<Node> node)
{
  m_node = node;
  ...
  sublayerprotocol->SetNode(node);
  cachemanager->SetNode(node);
  // Add a LoopbackNetDevice if needed, and an Ipv4Interface on top of it
  SetupLoopback ();
}

Ptr<Socket> 
Ipv4RouterL3Protocol::CreateRawSocket (void)
{
...
void 
Ipv4RouterL3Protocol::DeleteRawSocket (Ptr<Socket> socket)
{
 ...
 */
void
Ipv4RouterL3Protocol::NotifyNewAggregate ()
{
  if (m_node == 0)
    {
...
void 
Ipv4RouterL3Protocol::SetRoutingProtocol (Ptr<Ipv4RoutingProtocol> routingProtocol)
{
...
Ipv4RouterL3Protocol::GetRoutingProtocol (void) const
{
  return m_routingProtocol;
}

void 
Ipv4RouterL3Protocol::DoDispose (void)
{
...
void
Ipv4RouterL3Protocol::SetupLoopback (void)
{
  ...
  node->RegisterProtocolHandler (MakeCallback (&Ipv4RouterL3Protocol::Receive, this),
                                 Ipv4RouterL3Protocol::PROT_NUMBER, device);
  interface->SetUp ();
...
void 
Ipv4RouterL3Protocol::SetDefaultTtl (uint8_t ttl)
{
...
uint32_t 
Ipv4RouterL3Protocol::AddInterface (Ptr<NetDevice> device)
{
...
uint32_t 
Ipv4RouterL3Protocol::AddIpv4Interface (Ptr<Ipv4Interface>interface)
{
...
Ptr<Ipv4Interface>
Ipv4RouterL3Protocol::GetInterface (uint32_t index) const
{
...
uint32_t 
Ipv4RouterL3Protocol::GetNInterfaces (void) const
{
  NS_LOG_FUNCTION (this);
...
int32_t 
Ipv4RouterL3Protocol::GetInterfaceForAddress (
...
int32_t 
Ipv4RouterL3Protocol::GetInterfaceForPrefix (
  Ipv4Address address, 
  Ipv4Mask mask) const
{
...
int32_t 
Ipv4RouterL3Protocol::GetInterfaceForDevice (
...
bool
Ipv4RouterL3Protocol::IsDestinationAddress (Ipv4Address address, uint32_t iif) const
{
...
void 
Ipv4RouterL3Protocol::Receive ( Ptr<NetDevice> device, Ptr<const Packet> p, uint16_t protocol, const Address &from,
                          const Address &to, NetDevice::PacketType packetType)
{
  NS_LOG_DEBUG ("Packet received on node " <<m_node->GetId ());
...
*/
  ...
  Ptr<SublayerProtocol> sublayerprotocol = m_node->GetObject<SublayerProtocol> ();
  if (sublayerprotocol != NULL)
  {
	  packet = sublayerprotocol->OICNSublayerCheck(packet, ipHeader);
  }

  NS_ASSERT_MSG (m_routingProtocol != 0, "Need a routing protocol object to process packets");
  if (!m_routingProtocol->RouteInput (packet, ipHeader, device,
                                      MakeCallback (&Ipv4RouterL3Protocol::IpForward, this),
                                      MakeCallback (&Ipv4RouterL3Protocol::IpMulticastForward, this),
                                      MakeCallback (&Ipv4RouterL3Protocol::LocalDeliver, this),
                                      MakeCallback (&Ipv4RouterL3Protocol::RouteInputError, this)
                                      ))
    {
...
Ipv4RouterL3Protocol::GetIcmp (void) const
{
  NS_LOG_FUNCTION (this);
...
bool
Ipv4RouterL3Protocol::IsUnicast (Ipv4Address ad) const
{
...
bool
Ipv4RouterL3Protocol::IsUnicast (Ipv4Address ad, Ipv4Mask interfaceMask) const
{
...
void 
Ipv4RouterL3Protocol::SendWithHeader (Ptr<Packet> packet,
                                Ipv4Header ipHeader,
                                Ptr<Ipv4Route> route)
{
...
void 
Ipv4RouterL3Protocol::Send (Ptr<Packet> packet,
                      Ipv4Address source,
                      ...
                      Ptr<Ipv4Route> route)
{
  ...
  if (destination.IsBroadcast () || destination.IsLocalMulticast ())
    {
      NS_LOG_LOGIC ("Ipv4RouterL3Protocol::Send case 1:  limited broadcast");
      ...
      for (uint32_t j = 0; j < GetNAddresses (ifaceIndex); j++)
        {
          ...
          if (destination.IsSubnetDirectedBroadcast (ifAddr.GetMask ()) && 
            ...
            {
              NS_LOG_LOGIC ("Ipv4RouterL3Protocol::Send case 2:  subnet directed bcast to " << ifAddr.GetLocal ());
              ipHeader = BuildHeader (source, destination, protocol, packet->GetSize (), ttl, tos, mayFragment);
              Ptr<Packet> packetCopy = packet->Copy ();
              m_sendOutgoingTrace (ipHeader, packetCopy, ifaceIndex);
              packetCopy->AddHeader (ipHeader);
  ...
  if (route && route->GetGateway () != Ipv4Address ())
    {
      NS_LOG_LOGIC ("Ipv4RouterL3Protocol::Send case 3:  passed in with route");
      ipHeader = BuildHeader (source, destination, protocol, packet->GetSize (), ttl, tos, mayFragment);
  ...
  if (route && route->GetGateway () == Ipv4Address ())
    {
      ...
      // to be queried).
      NS_FATAL_ERROR ("Ipv4RouterL3Protocol::Send case 4: This case not yet implemented");
    }
  // 5) packet is not broadcast, and route is NULL (e.g., a raw socket call)
  NS_LOG_LOGIC ("Ipv4RouterL3Protocol::Send case 5:  passed in with no route " << destination);
  ...
  if (m_routingProtocol != 0)
    ...
    {
      NS_LOG_ERROR ("Ipv4RouterL3Protocol::Send: m_routingProtocol == 0");
    }
  if (newRoute)
    {
...
Ipv4Header
Ipv4RouterL3Protocol::BuildHeader (
  Ipv4Address source,
  Ipv4Address destination,
  uint8_t protocol,
...
void
Ipv4RouterL3Protocol::SendRealOut (Ptr<Ipv4Route> route,
                             Ptr<Packet> packet,
...
void
Ipv4RouterL3Protocol::IpMulticastForward (Ptr<Ipv4MulticastRoute> mrtentry, Ptr<const Packet> p, const Ipv4Header &header)
{
...
void
Ipv4RouterL3Protocol::IpForward (Ptr<Ipv4Route> rtentry, Ptr<const Packet> p, const Ipv4Header &header)
{
	NS_LOG_INFO(" Check ");//a
...
void
Ipv4RouterL3Protocol::LocalDeliver (Ptr<const Packet> packet, Ipv4Header const&ip, uint32_t iif)
{
...
bool
Ipv4RouterL3Protocol::AddAddress (uint32_t i, Ipv4InterfaceAddress address)
{
...
Ipv4RouterL3Protocol::GetAddress (uint32_t interfaceIndex, uint32_t addressIndex) const
{
...
uint32_t 
Ipv4RouterL3Protocol::GetNAddresses (uint32_t interface) const
{
...
bool
Ipv4RouterL3Protocol::RemoveAddress (uint32_t i, uint32_t addressIndex)
{
...
bool
Ipv4RouterL3Protocol::RemoveAddress (uint32_t i, Ipv4Address address)
{
...
Ipv4Address 
Ipv4RouterL3Protocol::SelectSourceAddress (Ptr<const NetDevice> device,
...
void 
Ipv4RouterL3Protocol::SetMetric (uint32_t i, uint16_t metric)
{
...
uint16_t
Ipv4RouterL3Protocol::GetMetric (uint32_t i) const
{
...
uint16_t 
Ipv4RouterL3Protocol::GetMtu (uint32_t i) const
{
...
bool 
Ipv4RouterL3Protocol::IsUp (uint32_t i) const
{
...
void 
Ipv4RouterL3Protocol::SetUp (uint32_t i)
{
...
void 
Ipv4RouterL3Protocol::SetDown (uint32_t ifaceIndex)
{
...
bool 
Ipv4RouterL3Protocol::IsForwarding (uint32_t i) const
{
...
void 
Ipv4RouterL3Protocol::SetForwarding (uint32_t i, bool val)
{
...
Ptr<NetDevice>
Ipv4RouterL3Protocol::GetNetDevice (uint32_t i)
{
...
void 
Ipv4RouterL3Protocol::SetIpForward (bool forward)
{
...
bool 
Ipv4RouterL3Protocol::GetIpForward (void) const
{
...
void 
Ipv4RouterL3Protocol::SetWeakEsModel (bool model)
{
...
bool 
Ipv4RouterL3Protocol::GetWeakEsModel (void) const
{
...
void
Ipv4RouterL3Protocol::RouteInputError (Ptr<const Packet> p, const Ipv4Header & ipHeader, Socket::SocketErrno sockErrno)
{
...
void
Ipv4RouterL3Protocol::DoFragmentation (Ptr<Packet> packet, uint32_t outIfaceMtu, std::list<Ptr<Packet> >& listFragments)
{
...
bool
Ipv4RouterL3Protocol::ProcessFragment (Ptr<Packet>& packet, Ipv4Header& ipHeader, uint32_t iif)
{
  ...
  if (it == m_fragments.end ())
    {
      ...
      m_fragmentsTimers[key] = Simulator::Schedule (m_fragmentExpirationTimeout,
                                                    &Ipv4RouterL3Protocol::HandleFragmentsTimeout, this,
                                                    key, ipHeader, iif);
    }
  else
    {
...
Ipv4RouterL3Protocol::Fragments::Fragments ()
  : m_moreFragment (0)
{
...
void
Ipv4RouterL3Protocol::Fragments::AddFragment (Ptr<Packet> fragment, uint16_t fragmentOffset, bool moreFragment)
{
...
bool
Ipv4RouterL3Protocol::Fragments::IsEntire () const
{
...
Ptr<Packet>
Ipv4RouterL3Protocol::Fragments::GetPacket () const
{
...
Ptr<Packet>
Ipv4RouterL3Protocol::Fragments::GetPartialPacket () const
{
...
void
Ipv4RouterL3Protocol::HandleFragmentsTimeout (std::pair<uint64_t, uint32_t> key, Ipv4Header & ipHeader, uint32_t iif)
{
